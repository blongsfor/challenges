...
console.log("first person name:", nameOfFirstPerson);
...
console.log("show friends:", homersOtherFriends);
...
console.log("show age 3rd person:", ageOfThirdPerson);
...
console.log("show mothers name:", mothersNameOfSecondPerson);
...
console.log("show pets name:", animaltypeOfLisasPet);
